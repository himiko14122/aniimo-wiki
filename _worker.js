// Cloudflare Worker entry for Aniimo Wiki
...
// IndexNow key (project-specific, aniimo-wiki.wiki): eb848db832a976d2a99b0c5523698687
const INDEXNOW_KEY = 'eb848db832a976d2a99b0c5523698687';
const HOST = 'www.aniimo-wiki.wiki';
...
async function handleIndexNow(request) {
  ...
  if (request.method === 'GET') {
    ...
    const locales = ['en', 'ja', 'ko', 'de'];
    const categories = [
      'guides', 'creatures', 'tier-list', 'evolution', 'twine',
      'egg-heist', 'homeland', 'multiplayer', 'locations', 'updates',
    ];
    const allUrls = [];
