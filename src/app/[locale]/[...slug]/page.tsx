...
export default async function CatchAllPage({ params }: { params: Promise<{ locale: string; slug: string[] }> }) {
  ...
  if (isContentType(first)) {
    ...
    const GUIDE_STOP_WORDS = new Set(['aniimo', 'twine', 'pathfinder', 'homeland', 'heist', 'egg', 'isles', 'creature', 'catching', 'rv', 'idyll', 'game', 'guide', 'list', 'wiki', 'complete', 'ultimate', 'best', 'build', 'tips', 'walkthrough', 'the', 'a', 'an', 'and', 'or', 'in', 'on', 'at', 'to', 'for', 'is', 'it', 'how', 'what', 'all', 'vs']);
