...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    keywords: ['Aniimo Wiki', 'Aniimo about', 'Aniimo community wiki', 'Aniimo fan wiki', 'Aniimo creature catching open world RPG'],
  };
}
      ...
      <section className="mb-10">
        ...
        <div className="card mb-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <a href={EXTERNAL_LINKS.store} target="_blank" rel="noopener noreferrer" title={t('about_playSteam')} className="card text-center hover:border-[var(--color-accent)] transition-colors">
