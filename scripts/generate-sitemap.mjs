...
const SITE_URL = 'https://aniimo-wiki.wiki';
...
const CONTENT_TYPES = ['guides', 'creatures', 'tier-list', 'evolution', 'twine', 'egg-heist', 'homeland', 'multiplayer', 'locations', 'updates'];
const NAV_PAGES = [
  { path: '/', priority: 1, changefreq: 'daily' },
  { path: '/guides', priority: 0.9, changefreq: 'weekly' },
  { path: '/creatures', priority: 0.9, changefreq: 'weekly' },
  { path: '/tier-list', priority: 0.9, changefreq: 'weekly' },
  { path: '/evolution', priority: 0.9, changefreq: 'weekly' },
  { path: '/twine', priority: 0.9, changefreq: 'weekly' },
  { path: '/egg-heist', priority: 0.9, changefreq: 'weekly' },
  { path: '/homeland', priority: 0.9, changefreq: 'weekly' },
  { path: '/multiplayer', priority: 0.8, changefreq: 'weekly' },
